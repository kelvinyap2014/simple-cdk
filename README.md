...
### Current state
The docker-compose.yml was tested fine against AWS credentials on actual AWS SQS and S3 environment generated by this `cdk deploy`. It was tested fine against localstack as well.
